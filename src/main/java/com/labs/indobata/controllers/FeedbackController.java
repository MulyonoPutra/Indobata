...
public class FeedbackController {
   ...
   */
  @DeleteMapping("/{id}")
  public ResponseEntity<ResponseMessages> deleteFeedback(@PathVariable Long id) {
  ...
  public ResponseEntity<FeedbackDTO> updateFeedback(
          @PathVariable(value = "id", required = false) final Long id, @Valid @RequestBody FeedbackDTO feedbackDTO) throws BadException {
